...
// @Param	body		body 	models.Meta	true		"body for Meta content"
// @Success 201 {object} models.Meta
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *MetaController) Post() {
	var v models.Meta
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoBogotaFormato()
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if _, err := models.AddMeta(&v); err == nil {
...
// @Success 200 {object} models.Meta
// @Failure 404 not found resource
// @router /:id [get]
func (c *MetaController) GetOne() {
...
// Put ...
// @Title Put
// @Description update the Meta
// @Param	id		path 	int	true		"The id you want to update"
// @Param	body		body 	models.Meta	true		"body for Meta content"
// @Success 200 {object} models.Meta
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *MetaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Meta{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Meta
// @Param	id		path 	int	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 404 not found resource
// @router /:id [delete]
func (c *MetaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
