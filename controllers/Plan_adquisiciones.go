...
type PlanAdquisicionesController struct {
	beego.Controller
}

// URLMapping ...
func (c *PlanAdquisicionesController) URLMapping() {
...
// @Success 201 {object} models.PlanAdquisiciones
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *PlanAdquisicionesController) Post() {
...
// @router /:id [get]
func (c *PlanAdquisicionesController) GetOne() {
...
// @Failure 404 not found resource
// @router / [get]
func (c *PlanAdquisicionesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllPlanAdquisiciones(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *PlanAdquisicionesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *PlanAdquisicionesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
