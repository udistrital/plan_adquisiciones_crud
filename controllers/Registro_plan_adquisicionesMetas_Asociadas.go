...
// RegistroPlanAdquisicionesMetasAsociadasController operations for RegistroPlanAdquisicionesMetasAsociadas
type RegistroPlanAdquisicionesMetasAsociadasController struct {
	beego.Controller
}

// URLMapping ...
func (c *RegistroPlanAdquisicionesMetasAsociadasController) URLMapping() {
...
func (c *RegistroPlanAdquisicionesMetasAsociadasController) Post() {
	var v models.RegistroPlanAdquisicionesMetasAsociadas
...
// @router /:id [get]
func (c *RegistroPlanAdquisicionesMetasAsociadasController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetRegistroPlanAdquisicionesMetasAsociadasById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
// @Title Get All
// @Description get RegistroPlanAdquisicionesMetasAsociadas
...
func (c *RegistroPlanAdquisicionesMetasAsociadasController) GetAll() {
	...
	l, err := models.GetAllRegistroPlanAdquisicionesMetasAsociadas(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *RegistroPlanAdquisicionesMetasAsociadasController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.RegistroPlanAdquisicionesMetasAsociadas{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateRegistroPlanAdquisicionesMetasAsociadasById(&v); err == nil {
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *RegistroPlanAdquisicionesMetasAsociadasController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteRegistroPlanAdquisicionesMetasAsociadas(id); err == nil {
