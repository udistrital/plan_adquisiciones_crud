...
// RegistroInversionActividadFuenteFinanciamientoController operations for RegistroInversionActividadFuenteFinanciamiento
type RegistroInversionActividadFuenteFinanciamientoController struct {
	beego.Controller
}

// URLMapping ...
func (c *RegistroInversionActividadFuenteFinanciamientoController) URLMapping() {
...
// @router /:id [get]
func (c *RegistroInversionActividadFuenteFinanciamientoController) GetOne() {
...
// GetAll ...
// @Title Get All
// @Description get RegistroInversionActividadFuenteFinanciamiento
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *RegistroInversionActividadFuenteFinanciamientoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *RegistroInversionActividadFuenteFinanciamientoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
